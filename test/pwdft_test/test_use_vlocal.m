function failFlag = test_use_vlocal()
% test with PWDFT using VLocal

% NOTE: currently only support ONCV type pseudopotential
...
inputFile = "./test_data/data_H2O/H2O_test_use_vlocal.in";
...
inputFile = "./test_data/data_SiH4/SiH4_test_use_vlocal.in";
...
fprintf('\n\n');
fprintf('=============================================================\n');
fprintf('                Test for using VLocal info\n');
