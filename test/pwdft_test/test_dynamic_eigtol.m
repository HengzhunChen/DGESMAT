function failFlag = test_dynamic_eigtol()
% test with PWDFT using dynamic eigTolerance 
...
inputFile = "./test_data/data_H2O/H2O_test_dynamic_eigtol.in";
...
inputFile = "./test_data/data_SiH4/SiH4_test_dynamic_eigtol.in";
...
fprintf('\n\n');
fprintf('=============================================================\n');
fprintf('             Test for using dynamic eigTolerance\n');
