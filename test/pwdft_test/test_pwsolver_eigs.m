function failFlag = test_pwsolver_eigs()
% test PW solver: eigsSolve
...
inputFile = "./test_data/data_H2O/H2O_test_pwsolver_eigs.in";
...
inputFile = "./test_data/data_SiH4/SiH4_test_pwsolver_eigs.in";
...
fprintf('\n\n');
fprintf('=============================================================\n');
fprintf('              Test for PW Solver eigsSolve\n');
