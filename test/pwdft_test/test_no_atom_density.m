function failFlag = test_no_atom_density()
% test user option: isUseAtomDensity == false, i.e., DO NOT use atom density 
% from upf file as initial value of density
...
inputFile = "./test_data/data_H2O/H2O_test_no_rhoAtom.in";
outputFile = "./test_data/data_H2O/H2O_statfile";
info = pwdft_main(inputFile, outputFile);

Eref = -1.7056129729020689e+01;
...
inputFile = "./test_data/data_SiH4/SiH4_test_no_rhoAtom.in";
outputFile = "./test_data/data_SiH4/SiH4_statfile";
info = pwdft_main(inputFile, outputFile);

Eref = -6.1871035443746569e+00;
...
fprintf('\n\n');
fprintf('=============================================================\n');
fprintf('      Test for not using UPF atom density to initialize \n');
