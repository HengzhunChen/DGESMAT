function failFlag = test_pwsolver_ppcg()
% test PW solver: PPCG
...
inputFile = "./test_data/data_H2O/H2O_test_pwsolver_ppcg.in";
...
inputFile = "./test_data/data_SiH4/SiH4_test_pwsolver_ppcg.in";
