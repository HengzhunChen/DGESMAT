function failFlag = test_upf_hgh_pp()
% test HGH type pseudo potential (read data from upf files)
...
inputFile = "./test_data/data_SiH4/SiH4_test_upf_hgh.in";
outputFile = "./test_data/data_SiH4/SiH4_statfile";
info = pwdft_main(inputFile, outputFile);

Eref = -6.1836161816852862e+00;
...
fprintf('\n\n');
fprintf('=============================================================\n');
fprintf('          Test for HGH_PBE type pseudo potential \n');
