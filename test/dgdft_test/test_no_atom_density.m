...
% test with not using atom density from UPF file to initialize density
...
inputFile = "./test_data/data_H2/H2_test_no_atom_density.in";
...
inputFile = "./test_data/data_LiNa/LiNa_test_no_atom_density.in";
