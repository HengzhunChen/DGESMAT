...
% test with using atom density from UPF file to initialize density

% NOTE: currently this should use with ONCV type pseudopotential
...
inputFile = "./test_data/data_H2/H2_test_upf_atom_density.in";
