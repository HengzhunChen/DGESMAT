function failFlag = test_hgh()
% test HGH type pseudo potential

% FIXME: This test use energy from pwdft as reference
...
inputFile = "./test_data/data_H2/H2_test_hgh.in";
...
inputFile = "./test_data/data_LiNa/LiNa_test_hgh.in";
...
fprintf('\n\n');
fprintf('=============================================================\n');
fprintf('            Test for HGH type pseudo potential \n');
