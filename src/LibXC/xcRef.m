function xcRef
% XCREF reference for exchange correlation.
%    Here attached an exchange correlation name convention and reference
%    list. (The original source for this list is Quantum ESPRESSO)
%
%    NOTE: 
%    For more detailed reference and more types of exchange correlation, 
%    see also xc functionals reference of libxc:
