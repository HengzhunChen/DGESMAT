function [EVdw, forceVdw] = CalculateVdwEnergyAndForce(HamKS)
% HAMILTONIANKS/CALCULATEVDWENERGYANDFORCE calculates van der Waals energy
%    and force.
%
...
if esdfParam.basic.VDWType == "DFT-D2"
    ...
    if HamKS.XCType == "XC_GGA_XC_PBE"
      vdw_s = vdw_s_pbe;
    elseif HamKS.XCType == "XC_HYB_GGA_XC_HSE06"
      vdw_s = vdw_s_hse;
    elseif HamKS.XCType == "XC_HYB_GGA_XC_PBEH"
      vdw_s = vdw_s_pbe0;
    else
